        ...
        return (
          <div className="space-y-6 text-slate-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <button
                onClick={() => navigate('/addProcessQuotation')}
                className="p-5 bg-white border border-slate-300 hover:border-amber-500 rounded-xl flex flex-col items-center justify-center gap-2 transition-all shadow-sm cursor-pointer hover:shadow-md group animate-fade-in"
              >
                <span className="font-extrabold text-lg text-slate-900 group-hover:text-amber-600">PROCESS</span>
                <span className="text-xs text-slate-500 font-semibold">Process Quotation</span>
              </button>
            </div>
